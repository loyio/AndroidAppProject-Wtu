package me.loyio.mycontacts.provider;
    ...
    public Cursor query(@NonNull Uri uri, @Nullable String[] columns, @Nullable String selection, @Nullable String[] selectionArgs, @Nullable String sortby) {
        ...
        switch (match){
            case CONTACT:
                ...
                L.d("ContactProvider query success");
    ...
    public Uri insert(@NonNull Uri uri, @Nullable ContentValues contentValues) {
        ...
        switch (match){
            case CONTACT:
                ...
                if (id!=-1){
                    L.d("ContactProvider insert success");
    ...
    public int delete(@NonNull Uri uri, @Nullable String s, @Nullable String[] strings) {
        ...
        switch (match){
            case CONTACT:
                ...
                if (deletecount>0){
                    L.d("ContactProvider delete success");
    ...
    public int update(@NonNull Uri uri, @Nullable ContentValues contentValues, @Nullable String s, @Nullable String[] strings) {
        ...
        switch (match){
            case CONTACT:
                ...
                if (updatecount>0){
                    L.d("ContactProvider update success");
